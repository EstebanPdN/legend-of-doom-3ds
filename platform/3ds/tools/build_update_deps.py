#!/usr/bin/env python3
"""Build Legend of Doom's pinned 3DS updater dependencies without publishing binaries."""
...
jobs = os.environ.get('LOD3DS_JOBS', '4')
...
with tempfile.TemporaryDirectory(prefix='lod-update-') as temp:
